        ...
        <div className="flex flex-col items-center justify-center min-h-screen py-4 bg-slate-300">
            ...
            <div className="block p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <div class="flex p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
                    ...
                    <div>
                        Die folgenden Parameter zeigen, welches Niveau für eine niedrigere Preiseinstufung notwendig gewesen wäre.<br />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                    ...
                    {casenumber.explanation.visualSensitivity.map((param) => {
                        return (
                            <ParameterCard 
                                link="#"
                    ...
                    <div className="lg:col-span-7 mb-4 md:mb-0">
                        ...
                        <div id="chart" ref={chartRef}>
                            ...
                            <ResponsiveContainer width={"100%"} height={300}>
                                <LineChart data={selectedParameter.data} margin={{ top: 0, right: 0, bottom: 20, left: 0 }}>
                                    ...
                                    />
                                    <ReferenceLine 
                                        x={selectedParameter.referenceArea.x1} 
                                        stroke="green" 
                                        label=
                                        {
                                            { 
                                                value: `${selectedParameter.referenceArea.label}`, 
                                                position: `${selectedParameter.referenceArea.position}` 
                                            }
                                        } 
                                    />
                                    {selectedParameter.referenceArea && (
                                        <ReferenceArea 
                                            x1={selectedParameter.referenceArea.x1} 
                                            x2={selectedParameter.referenceArea.x2}
...
export default VisualSensitvityExplanation;