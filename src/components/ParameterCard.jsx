const ParameterCard = ({ link, onClick, active, heading, badgeType, badgeText, body }) => {
    return (
        <a href={link} onClick={onClick} className={`block max-w-sm p-6 ${active?'bg-gray-200' : 'bg-white'} border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700`}>
